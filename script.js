...
const parrafo = document.getElementById('quote-text')
...
const obtenerConsejo = async () => {
    try {
        ...
        parrafo.textContent = 'Cargando consejo...'
        ...
        parrafo.textContent = 'No se pudo obtener el consejo. Inténtalo nuevamente.'
    } finally {
